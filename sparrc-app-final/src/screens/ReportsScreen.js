...
import { FileText, User, Calendar, Phone, Heart, Stethoscope, Pill, Download, Home, Briefcase } from 'lucide-react-native';
    ...
    return (
        <ScrollView style={styles.screenContainer}>
            ...
            <View style={styles.card}>
                ...
                <DetailRow icon={Calendar} label="Age" value={patient.age?.toString()} />
                ...
                <DetailRow icon={Home} label="Address" value={patient.address} />
